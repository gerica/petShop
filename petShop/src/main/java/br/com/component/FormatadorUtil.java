...
public class FormatadorUtil {
	...
	/**
	 * Retorna um array com a menor e maior data de um determinado mês.
	 * 
	 * @param data
	 *            [] array na primeira posicao estará a maior data, a segunda
	 *            posição estrará a menor data
	 * @return
	 */
	public static Date[] getDataMesAnterior(Date data) {
		...
		datas[0] = hoje.withMonthOfYear(mesHoje).withYear(anoHoje).dayOfMonth().withMaximumValue().toDate(); // Data
																												// maior
		datas[1] = hoje.withMonthOfYear(mesHoje).withYear(anoHoje).dayOfMonth().withMinimumValue().toDate(); // Data
																												// menor
		return datas;
	}
	...
	public static void main(String[] args) throws ParseException {
		System.out.println(FormatadorUtil.formatarMoeda(new BigDecimal(-33220000)));
	}
