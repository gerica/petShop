petShoepApp.controller("petController", [
		'$scope', '$uibModal', '$log', 'petShopHttpFacade', function($scope, $uibModal, $log, petShopHttpFacade) {
			...
			self.pages = {
				"cadastro" : "pet/cadastro.html",
				"lista" : "pet/lista.html",
			};
			...
			self.open = function(size, pet) {
				...
				var modalInstance = $uibModal.open({
					...
					templateUrl : '/petShop/pet/modalDetalhe.html',
...
petShoepApp.controller('modalDetalhePetController', [
		'$uibModalInstance', '$log', 'pet', function($uibModalInstance, $log, pet) {
			var self = this;
			self.pet = pet;
